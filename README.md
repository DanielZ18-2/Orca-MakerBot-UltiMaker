...
- **Network printing + a Device tab:** live telemetry, webcam, print controls (pause / resume / cancel), global Z-offset adjustment, and a start-print flow with an on-camera build-plate confirmation
