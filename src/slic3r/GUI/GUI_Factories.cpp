...
wxMenu* MenuFactory::append_submenu_add_handy_model(wxMenu* menu, ModelVolumeType type) {
    ...
    static const std::vector<HandyModel> makerbot_heritage_models = {
        ...
        {L("MakerBot Key Ring"),       {"MakerBot Key Ring.3mf"},             false },
        ...
        {L("Hilbert Cube"),            {"hilbert_cube1.drc"},                 true },
        {L("Unleash Your Creativity"), {"Unleash_Your_Creativity.drc"},        true },
        {L("Bearing"),                 {"Bearing.drc"},                        true },
        {L("Giro"),                    {"giro.drc"},                           true },
        {L("OK Hand"),                 {"ok_hand.drc"},                        true },
        {L("2-Color Dragon"),          {"MakerBot Dragon Heart.3mf"},         false },
        {L("Traffic Cone"),            {"MakerBot Traffic Cone.3mf"},         false },
        {L("Dual-Color Cupcake"),      {"MakerBot Cupcake.3mf"},              false },
    };
